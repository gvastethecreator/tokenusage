...
| Microsoft.Windows.SDK.BuildTools.WinApp | 0.6.1 | Kept private to the app project |
...
| actions/configure-pages | v6.0.0 | Current stable Pages setup action |
| actions/upload-pages-artifact | v5.0.0 | Current stable Pages artifact action |
| actions/deploy-pages | v5.0.1 | Current stable Pages deployment action |

The review also covered CommunityToolkit.Mvvm 8.4.2, Microsoft.Data.Sqlite
10.0.11, SQLitePCLRaw 3.0.5, Windows SDK Build Tools 10.0.28000.2705,
...
dependency check and vulnerability audit cover every project in
`TokenUsage.slnx`, including the Windows packaging project.
