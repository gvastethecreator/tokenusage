...
$checks = @(
    ...
    @{ Name = 'Claude and Grok source appears'; Id = 'UsageProductCard.DataOrigin'; Value = 'Grok Build' },
...
$artifactDirectory = Join-Path $PSScriptRoot '..\..\artifacts\ticket-18'
New-Item -ItemType Directory -Force -Path $artifactDirectory | Out-Null
winapp ui screenshot -a $AppPid -o (Join-Path $artifactDirectory 'grok-local-usage.png') 2>$null | Out-Null
